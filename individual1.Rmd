...
```
The graph shows that turnovers and sacks are rare in defensicve stats. This would make sense as this is primarily an offensive thing.  
...
```{r}
defClean3 <- defClean %>% select(Name, Opponent_Opponent, Statistic) %>% spread(Opponent_Opponent,Tackles_Solo)
